        ...
        return (
            <Fragment>
                ...
                <Navbar variant={this.state.navVariant} className={this.state.navBarBack} fixed="top" collapseOnSelect expand="lg">
                    <Navbar.Brand ><NavLink className={this.state.navBarTitle} to="/"><img src={this.state.navBarLogo}/> Rahib Rahman</NavLink> </Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                          ...
                          <Nav.Link>   <NavLink exact activeStyle={{color:'#00a8ee'}} className={this.state.navBarItem} to="/course">SKILLS</NavLink></Nav.Link>
